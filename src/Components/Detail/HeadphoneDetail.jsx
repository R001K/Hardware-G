...
const HeadphoneDetail = () => {
    ...
    const fetchProduct = async () => {
      try {
        const response = await databases.getDocument(
          ...
          import.meta.env.VITE_HEADPHONE_COLLECTION_ID, // Collection ID
  ...
  const addToCart = async () => {
    ...
    const cartItem = {
      ...
      collectionId: import.meta.env.VITE_HEADPHONE_COLLECTION_ID,
          ...
          <div className="border border-gray-300 rounded-lg p-4 bg-gray-50 shadow-lg">
            <table className="table-auto w-full text-gray-700 mb-6">
              ...
              <tbody>
                ...
                <tr>
                  <td className="px-4 py-2 font-semibold">Microphone</td>
                  <td className="px-4 py-2">{microphone}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2 font-semibold">Wireless</td>
                  <td className="px-4 py-2">{wireless}</td>
                </tr>
                <tr>
