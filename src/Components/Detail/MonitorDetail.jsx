...
const MonitorDetail = () => {
    ...
    const fetchProduct = async () => {
      try {
        const response = await databases.getDocument(
          ...
          import.meta.env.VITE_MONITOR_COLLECTION_ID, // Collection ID
  ...
  const addToCart = async () => {
    ...
    const cartItem = {
      ...
      collectionId: import.meta.env.VITE_MONITOR_COLLECTION_ID,
            ...
            <table className="table-auto w-full text-gray-700 mb-6">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="px-4 py-2">{screen_size}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2 font-semibold">Resolution</td>
                  <td className="px-4 py-2">{resolution}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2 font-semibold">Refresh Rate</td>
                  <td className="px-4 py-2">{refresh_rate}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2 font-semibold">Panel Type</td>
                  <td className="px-4 py-2">{panel_type}</td>
                </tr>
                <tr>
